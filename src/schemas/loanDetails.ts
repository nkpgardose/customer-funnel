...
export const FORMATTED_MIN_VEHICLE_PRICE = audCurrencyFormat.format(MIN_VEHICLE_PRICE)
export const FORMATTED_MIN_LOAN_AMOUNT = audCurrencyFormat.format(MIN_LOAN_AMOUNT)
